...
export interface HeadwindsHomeTemplateProps {
  header: React.ReactNode;
  hero: React.ReactNode;
  sidequest: React.ReactNode;
  footer: React.ReactNode;
  isBlockedIn?: boolean;
}

const HeadwindsHomeTemplate = ({
  header,
  hero,
  sidequest,
  footer,
  ...
  return (
    <Grid customClass={styles.gridContainer}>
      ...
      <Row customClass={styles.content}>
        <Column
          customClass={clsx(styles.sidequest, {
            [styles.commonBlockedIn]: isBlockedIn,
          })}
        >
          {sidequest}
        ...
        <Column
          customClass={clsx(styles.hero, {
            [styles.heroBlockedIn]: isBlockedIn,
          })}
        >
          {hero}
        </Column>

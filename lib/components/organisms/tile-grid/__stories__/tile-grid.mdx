...
So just how many tiles do we need to create a game? Tic tac toe has 6 while chess has 64 but in a terms of a grid we usually the think of a minimum of 4 tiles since 2 tiles is either a row or column. 

A 6 tile row could be perfect for a shop keeper and I've certainly spent plenty time buying and selling items within this space and never find confined or limited in game play especially when complimenting the experience with inventory and other decision-based modals.
...
I think the game might have been [Pool of Radiance](https://en.wikipedia.org/wiki/Pool_of_Radiance). I only remember the maps and the experience, especially a particularly frigid, ice-themed dungeon.

This is package was basically the only co-operative experience I had with games otherwise I played everything (Ultima, Might & Magic, Sierra) basically alone. I have no memories of discussing RPGs with friends except for Michael Barenburg who introduced me to Mech and Matzo ball soup. And lox! We also earned our winter camping badge together in Scouts. I considered him "rich" because they had a massive house on many acres of woodlands which was a pretty safe place to camp in 4 feet of snow.

## Usage

`totalInRow` is the number of tiles in a row.

To achieve a 3x3 grid, you would set `totalInRow` to 3 and then create 9 models.
...
- https://boingboing.net/2024/10/25/this-free-puzzle-game-fixes-everything-wrong-with-the-classic-battleship.html

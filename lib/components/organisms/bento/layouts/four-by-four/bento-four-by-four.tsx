...
import styles from "./bento-four-by-four.module.css";
...
const BentoFourByFour = ({
  boxes = defaultComponentSlots,
  borderRadius = 5,
  gap = 16,
  entireBoxBackgroundColor = "transparent",
}: BentoFourByFourProps) => {
  const { one, two, three, four, five, six, seven, eight, nine, ten } = boxes;
  return (
    <Column
...
export default BentoFourByFour;

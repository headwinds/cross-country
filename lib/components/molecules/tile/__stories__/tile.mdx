...
import { Link } from "@headwinds/cross-country/components";
...
In games or sci-fi films, it is common to see the corners of tile hi-light and pulse when the tile is activated.
...
Color interpolation is an interesting approach to transitioning a tile's colour from one to another.
...
<Canvas of={TileStories.ConcreteTileStory} />

<Canvas of={TileStories.WaterTile} />

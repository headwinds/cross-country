...
There text input comes in two flavors: the regular text input and the state machine text input. This is the first text input that I developed and may deprecate since the state machine text input is more flexible and has more features.
...
<Canvas of={InputStories.StandardWithDefaultValue} />

<Canvas of={InputStories.StateMachineContenteditable} />

...
export function getRSSBranch(candidateBranch, index, ix) {
  ...
  if (title === 'National Geographic Photo of the Day') title = 'National Geographic';
  ...
  else if (title.trim() === 'Abduzeedo Design Inspiration - Design Inspiration & Tutorials')
    title = 'Abduzeedo';
  ...
  else if (title.trim() === 'Y! Sports Blogs  - Yahoo Canada Sports') title = 'Yahoo Sports';
  else if (title.trim() === 'International Documentary Association') title = 'Documentary';
  ...
  else if (title.trim() === 'Sports - The Inquisitr News') title = 'The Inquisitr';
  else if (title.trim() === 'designboom | architecture & design magazine') title = 'designboom';

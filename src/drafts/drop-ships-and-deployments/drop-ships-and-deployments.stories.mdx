  ...
  articles={[
    {
      ...
      url: 'https://vercel.com/templates/next.js/agent-gpt',
    },
    { id: 1, title: 'Deploying LangChain to Fly.io', url: 'https://fly.io/blog/deploying-langchain-to-fly-io/' },
    {
      id: 2,
      title: 'Generative Agents in LangChain',
      url: 'https://python.langchain.com/en/latest/use_cases/agent_simulations/characters.html#create-a-generative-character',
    },
  ]}
/>

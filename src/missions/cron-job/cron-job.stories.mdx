...
# Automation Testings & Tasks

<Subtitle>How can we automate serverless functions?</Subtitle>

<Paragraph>
When using serverless, the server sleeps when not in use. As far as I know, it is impossible to setup a task that occurs frequently at a certain time aka a cron job. s working each week?
</Paragraph>

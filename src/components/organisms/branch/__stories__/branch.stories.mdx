...
<Paragraph>
When considering tree traversal, the leaf node is the final node. It is an end. Leaves cannot have more leaves nor branhes. 
</Paragraph>
<Paragraph>
A branch is a node that has more than one leaf. It must "branch" at least once. 
</Paragraph>
